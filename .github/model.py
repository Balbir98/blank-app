...
if uploaded_file:
    ...
    reg_df = df.dropna(subset=feature_cols + ['Annualised Projected Income Current Year'])
    n_reg = len(reg_df)
    ...
    if n_reg >= 2:
        ...
        y_reg = reg_df['Annualised Projected Income Current Year']
    ...
    clf_df = df.dropna(subset=feature_cols + [
